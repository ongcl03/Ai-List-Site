...
function Card() {
  return (
    <div className=" animate-fade-in border text-card-foreground w-[350px] bg-[#1A1C2C] rounded-lg overflow-hidden shadow-xl transition-transform transform hover:scale-105">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-400 mb-4">
          AI Tool description goes here. It's a brief summary of the tool's
